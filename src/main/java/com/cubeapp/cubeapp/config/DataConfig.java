...
//import com.cubeapp.cubeapp.interceptor.EventLogInterceptor;
//
...
//        log.info("DataConfig, SETTING MONGODB DATA SOURCE");
//
...
//                .url("spring.data.mongodb.uri=mongodb://localhost?createDatabaseIfNotExist=true")
//                // .username(userName)
//                // .password(password)
//                .build();
//
